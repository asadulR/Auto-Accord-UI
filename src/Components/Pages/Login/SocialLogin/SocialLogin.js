    ...
    return (
        <div>
            ...
            <div className='w-75 mx-auto'>
                {loginError}
                <button onClick={() => signInWithGoogle()} className='w-100 btn another-signin-btn my-2 btn-white'> <img className='me-3 social-icon' src={google} alt="" />Log in with Google</button>
